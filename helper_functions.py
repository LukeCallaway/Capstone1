...
def get_all_info(id):
    """Gets all info for 1 movie by id"""
...
def get_similar_titles(list):
    """Grabs all movies on a given list"""
    sim_titles_info = {}
    i = 0
...
def get_sim_to_favs(lst):
    """Return list of similar titles from a list of ids"""
...
def get_suggestions(user_id):
    ...
    if len(favorites) > 2:
        ...
        return [get_sim_to_favs(favorites), get_sim_to_favs(favorites), get_sim_to_favs(favorites)]
